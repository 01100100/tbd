...
[https://www.textfixer.com/tutorials/country-dropdowns.php](https://www.textfixer.com/tutorials/country-dropdowns.php) - A simple list of countries in HTML. No configurable presets. No preview. Otherwise, a pretty good tool and the best I have found so far.

![textfixer.com](screenshots/textfixer.png)
...
![dropdowngenerator.com](screenshots/dropdowngenerator.com.png)

[https://dropdownmenugenerator.github.io/](https://dropdownmenugenerator.github.io/) - Overly complex UI, no country presets.

![dropdownmenugenerator.github.io/](screenshots/dropdownmenugenerator.github.io.png)
...
Configurable Options (The idea would be to reduce the number of options to the minimum necessary to make the tool useful and have some good "sane" presets):
...
- Enhanced Search:
    "Did you mean?" suggestions for misspellings or alternative names like "UK" vs. "United Kingdom."
- Dropdown styling
  - color
  - size
  - shape
...
- code snippet
- Copy Code snippet to clipboard button and feedback
- "ABOUT"
